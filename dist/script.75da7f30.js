...
function setupShoppingCart() {
  (0, _addGlobalEventListener.default)('click', '[data-remove-cart-button]', function (e) {
...
function renderCartItems() {
  ...
  cartQuantity.innerText = shoppingCart.length; // calculate accurate total

  var totalCents = shoppingCart.reduce(function (sum, entry) {
    var item = _items.default.find(function (item) {
  ...
  shoppingCart.forEach(function (entry) {
    ...
    image.src = "https://dummyimage.com/210x130/".concat(item.imageColor, "/").concat(item.imageColor);
...
function setupStore() {
  if (storeItemContainer == null) return; // Handle click event for adding
...
},{"./items.json":"items.json","./util/formatCurrency":"util/formatCurrency.js","./util/addGlobalEventListener.js":"util/addGlobalEventListener.js","./shoppingCart.js":"shoppingCart.js"}],"script.js":[function(require,module,exports) {
"use strict";
